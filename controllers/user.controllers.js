...
// let{weekly,monthly,alltime}=req.query
// let dateFilterStage = {};
// const now = new Date();
// if (weekly === "true") {
...
//   dateFilterStage = {
//     $match: { "userlist.createdAt": { $gte: lastWeek, $lte: now } }
//   };
...
//         $facet: {
//           users: [
//             ...(Object.keys(dateFilterStage).length > 0 ? [dateFilterStage] : []),
//             {
//               $project: {
//                 name: 1,
//                 points: "$userlist.points",
//                 tsads: "$userlist.tsads"
//               }
//             },
//         {
//           $sort: { 
...
//           _id: null,
//           totalUsers: { $sum: 1 },
//           totalPoints: { $sum: "$userlist.points" },
//           totaltsads: { $sum: "$userlist.tsads" },
//           totalAddsWatch:{$sum:"$userlist.watched_ads"}
//         }
//       }
//     ]}
//   }
